...
const UZ: Record<string, string> = {
  ...
  "Know where your money goes.": "Pulingiz qayerga ketishini biling.",
  "Current Balance": "Joriy balans",
  "Savings Health": "Jamg'arma salomatligi",
  "Add Income": "Kirim qo'shish",
  "Add Expense": "Chiqim qo'shish",
  "Savings Goal": "Jamg'arma maqsadi",
  "Recurring Payment": "Doimiy to'lov",
  "Scan Receipt": "Chekni skanerlash",
  soon: "tez orada",
  Remaining: "Qoldi",
  Reached: "Yetildi",
  Monthly: "Oylik",
  ...
  // ── Running section ──
  "Sync Strava": "Strava sinxron",
  "Syncing…": "Sinxronlanmoqda…",
  "Connect Strava": "Strava ulash",
  "Avg pace": "O'rtacha temp",
  Longest: "Eng uzun",
  "Distance (km)": "Masofa (km)",
  "Time (min : sec)": "Vaqt (daq : son)",
  Pace: "Temp",
  "Log run": "Yugurishni yozish",
  // ── Sleep card ──
  "Log sleep": "Uyquni yozish",
  "Avg sleep this week": "Bu hafta o'rtacha uyqu",
  Sleeping: "Uxlayapsiz",
  "Wake up": "Uyg'onish",
  "or log hours": "yoki soatni yozing",
  "Hours slept": "Uxlagan soat",
  "Quality (optional)": "Sifat (ixtiyoriy)",
  "Save sleep": "Uyquni saqlash",
  ...
  "ISA can see your whole life — its insights are at their sharpest.":
    "ISA butun hayotingizni ko'ryapti — tahlillari eng o'tkir holatda.",
  ...
  Sleep: "Uyqu",
  // ── Sleep card (morning-first) ──
  "Today's sleep": "Bugungi uyqu",
  Mark: "Belgilash",
  "How did you sleep?": "Qanday uxladingiz?",
  "Slept badly": "Yomon",
  "Slept okay": "O'rtacha",
  "Slept well": "Yaxshi",
  "Slept great": "Zo'r",
  estimated: "taxminiy",
  Estimated: "Taxminiy",
  "manually entered": "qo'lda kiritilgan",
  "Sleep time not set yet": "Uyqu vaqti hali aniqlanmagan",
  Change: "O'zgartirish",
  "My bedtime": "Yotgan vaqtim",
  "My wake time": "Uyg'ongan vaqtim",
  "One tap saves it.": "Bir teginish — saqlaydi.",
  "Couldn't save your sleep.": "Uyquni saqlab bo'lmadi.",
  "This week you slept {avg} on average.": "Bu hafta o'rtacha {avg} uxladingiz.",
  Running: "Yugurish",
  ...
  overdue: "muddati o'tgan",
  "Today's Timeline": "Bugungi jadval",
  "Today's Habits": "Bugungi odatlar",
  "Add event": "Hodisa qo'shish",
  // ── Calendar events (meetings + reminders) ──
  Event: "Hodisa",
  "New event": "Yangi hodisa",
  "e.g. Meeting with the team": "masalan, Jamoa bilan uchrashuv",
  "Remind me": "Eslatib tur",
  "1 day before": "Bir kun oldin",
  "1 hour before": "Bir soat oldin",
  "Reminders arrive as push notifications.": "Eslatmalar bildirishnoma ko'rinishida keladi.",
  "Save event": "Hodisani saqlash",
  "Couldn't save the event.": "Hodisani saqlab bo'lmadi.",
  Events: "Hodisalar",
  "Nothing planned.": "Reja yo'q.",
  Schedule: "Sana belgilash",
  // ── Savings / reminders / habits / auth ──
  "Add money": "Pul qo'shish",
  "Add to {name}": "{name}ga qo'shish",
  "Turn off": "O'chirish",
  "Notifications turned off.": "Bildirishnomalar o'chirildi.",
  "Mark \"{name}\" as done?": "\"{name}\" bajarildi deb belgilansinmi?",
  "Mark done": "Bajarildi",
  "Continue with Google": "Google bilan kirish",
  or: "yoki",
  "Event name": "Hodisa nomi",
  "No events yet — add your day's plan.": "Hali hodisa yo'q — kuningiz rejasini qo'shing.",
  Now: "Hozir",
  "day streak": "kunlik streak",
  Energy: "Energiya",
  d: "k",
  "Quick actions": "Tezkor amallar",
  Note: "Eslatma",
  "Optimize my day": "Kunimni optimallashtir",
  ...
  // ── Journal v2 ──
  Journaling: "Kundalik",
  "Today's journal": "Bugungi kundalik",
  "Start writing…": "Yozishni boshlang…",
  Gratitude: "Minnatdorchilik",
  Lessons: "Saboqlar",
  "Longest streak": "Eng uzun ketma-ketlik",
  "Current streak": "Joriy ketma-ketlik",
  "Total entries": "Jami yozuvlar",
  "Avg words": "O'rtacha so'z",
  "This month": "Bu oy",
  entries: "yozuv",
  "per entry": "har yozuvda",
  "Writing streak": "Yozish ketma-ketligi",
  "Today's Journal Goals": "Bugungi kundalik maqsadlari",
  "Write today": "Bugun yozing",
  "Reflect (50+ words)": "Chuqur yozing (50+ so'z)",
  "Log your mood": "Kayfiyatingizni belgilang",
  "Memory Reminder": "Xotira eslatmasi",
  "View Memory": "Xotirani ko'rish",
  "Recent Entries": "So'nggi yozuvlar",
  Reflections: "Mulohazalar",
  Pro: "Pro",
  Entry: "Yozuv",
...
const RU: Record<string, string> = {
  ...
  "Know where your money goes.": "Знайте, куда уходят деньги.",
  "Current Balance": "Текущий баланс",
  "Savings Health": "Здоровье сбережений",
  "Add Income": "Добавить доход",
  "Savings Goal": "Цель сбережений",
  "Recurring Payment": "Регулярный платёж",
  ...
  "Show {n} more": "Ещё {n}",
  // ── Running section ──
  "Sync Strava": "Синхр. Strava",
  "Syncing…": "Синхронизация…",
  "Connect Strava": "Подключить Strava",
  "Avg pace": "Средний темп",
  Longest: "Самый длинный",
  "Distance (km)": "Дистанция (км)",
  "Time (min : sec)": "Время (мин : сек)",
  Pace: "Темп",
  "Log run": "Записать пробежку",
  // ── Sleep card ──
  "Log sleep": "Записать сон",
  "Avg sleep this week": "Средний сон за неделю",
  Sleeping: "Сон идёт",
  "Wake up": "Проснуться",
  "or log hours": "или ввести часы",
  "Hours slept": "Часов сна",
  "Quality (optional)": "Качество (необязательно)",
  "Save sleep": "Сохранить сон",
  ...
  "ISA can see your whole life — its insights are at their sharpest.":
    "ISA видит всю вашу жизнь — её выводы максимально точны.",
  ...
  estimated: "примерно",
  Estimated: "Примерно",
  "manually entered": "вручную",
  "Sleep time not set yet": "Время сна пока не определено",
  Change: "Изменить",
  "My bedtime": "Время отхода ко сну",
  "My wake time": "Время пробуждения",
  "One tap saves it.": "Одно нажатие — сохранено.",
  "Couldn't save your sleep.": "Не удалось сохранить сон.",
  "This week you slept {avg} on average.": "На этой неделе вы спали в среднем {avg}.",
  Running: "Бег",
  "ISA sees the whole picture — its patterns and predictions are at their strongest.":
  ...
  "e.g. Meeting with the team": "напр., Встреча с командой",
  "Remind me": "Напомнить",
  "1 day before": "За день до",
  "1 hour before": "За час до",
  "Reminders arrive as push notifications.": "Напоминания приходят как уведомления.",
  "Save event": "Сохранить событие",
  "Couldn't save the event.": "Не удалось сохранить событие.",
  Events: "События",
  "Nothing planned.": "Ничего не запланировано.",
  Schedule: "Выбрать дату",
  // ── Savings / reminders / habits / auth ──
  "Add money": "Добавить деньги",
  "Add to {name}": "Добавить в {name}",
  "Turn off": "Выключить",
  "Notifications turned off.": "Уведомления выключены.",
  "Mark \"{name}\" as done?": "Отметить \"{name}\" выполненным?",
  "Mark done": "Выполнено",
  "Continue with Google": "Войти через Google",
  or: "или",
  "Event name": "Название события",
  "No events yet — add your day's plan.": "Событий пока нет — добавьте план дня.",
  Now: "Сейчас",
  ...
  Note: "Заметка",
  "Optimize my day": "Оптимизировать день",
  ...
  Insights: "Инсайты",
  "Today's journal": "Дневник за сегодня",
  ...
  "Avg words": "Среднее слов",
  "This month": "Этот месяц",
  entries: "записей",
  "per entry": "на запись",
  "Writing streak": "Серия записей",
  "Today's Journal Goals": "Цели дневника на сегодня",
  "Write today": "Написать сегодня",
  "Reflect (50+ words)": "Отразить (50+ слов)",
  "Log your mood": "Отметьте настроение",
  "Memory Reminder": "Напоминание из прошлого",
  "View Memory": "Открыть запись",
